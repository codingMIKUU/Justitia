...
/* Define to 1 to enable wqe-foramt annotations. */
/* #undef MLX4_WQE_FORMAT */
...
#define PACKAGE_STRING "libmlx4 1.2.1mlnx1"
...
#define PACKAGE_VERSION "1.2.1mlnx1"
